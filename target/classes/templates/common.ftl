    ...
    <html lang="en" xmlns:th="http://www.thymeleaf.org">
        ...
        <body>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarSettings">
                                <a class="dropdown-item btn-sm" href="/customerDiscount/list">Скидки клиентов</a>
                                <a class="dropdown-item btn-sm" href="/productDiscount/list">Скидки товаров</a>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="container-fluid">
                <#nested/>
                <#if message??>
                    <div class="modal fade" id="message" role="dialog" aria-labelledby="modalMessage">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-body" style="padding: 3px;">
                                    <div class="alert alert-${message.color} text-center" role="alert" style="margin: 0">${message.text}</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <script>$(document).ready(function(){$("#message").modal();});</script>
        </body>
    </html>
</#macro>